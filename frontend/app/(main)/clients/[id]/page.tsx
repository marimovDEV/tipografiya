...
export default function ClientDetailPage() {
    ...
    const [paymentData, setPaymentData] = useState({ amount: "", method: "cash", description: "" });
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={paymentData.method} onValueChange={v => setPaymentData({ ...paymentData, method: v })}>
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="transfer">Pul o'tkazish</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                                <div className="space-y-2">
                    ...
                    <CardContent className="pt-6">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <h3 className={`text-2xl font-bold mt-2 ${balance < 0 ? 'text-red-600' : 'text-green-600'}`}>
                                ...
                                <TableBody>
                                    {transactions.length > 0 ? transactions.map((t) => (
                                        <TableRow key={t.id}>
                                            ...
                                            <TableCell>
                                                <Badge variant={t.type === 'income' ? 'default' : 'destructive'} className="bg-opacity-10 text-opacity-100">
