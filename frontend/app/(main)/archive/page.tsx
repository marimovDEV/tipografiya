    ...
    return (
        <div className="space-y-4 pb-20">
            ...
            <div className="flex gap-2">
                ...
                <HelpText>📄 Excel export qilish uchun yuqoridagi tugmani bosing</HelpText>
            </div>

            <HelpBox variant="green" title="🎯 Arxiv sahifasi">
                Tugallangan buyurtmalarni ko'ring. Qidirish orqali eski buyurtmalarni toping va Excel formatida yuklab olishingiz mumkin.
            </HelpBox>
