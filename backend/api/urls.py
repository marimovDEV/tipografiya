...
urlpatterns = [
    ...
    path('automation/run-checks/', RunAutomationChecksView.as_view(), name='run-automation-checks'),
    path('automation/deadline-alerts/', DeadlineAlertsView.as_view(), name='deadline-alerts'),
    path('automation/bottleneck-alerts/', BottleneckAlertsView.as_view(), name='bottleneck-alerts'),
    path('automation/orders/<int:order_id>/trigger-workflow/', TriggerWorkflowView.as_view(), name='trigger-workflow'),
